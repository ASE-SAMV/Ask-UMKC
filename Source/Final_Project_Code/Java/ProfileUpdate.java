...
public class ProfileUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email=(Button)findViewById(R.id.email_id);
            ...
            if( passwrd.getText().toString().equals(repasswrs2.getText().toString())) {
                ...
                try {
                   ...
                   imgString= imgString.replace("\n","");
                    jsonObject.put("img",imgString.toString());
...
//                    jsonObject.put("followed_questions", new JSONArray(sam));
            ...
            {
                Toast.makeText(getApplicationContext(), "paswords are not equl", Toast.LENGTH_LONG).show();
            }
        }
        else
        {
