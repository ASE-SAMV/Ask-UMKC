   ...
   public EditText et1,et2;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            ...
            if(resultCode==10)
            {
                    Log.d("Data val",data.getStringExtra("Data"));
                Log.d("Email",data.getStringExtra("gmail"));
            }
        }
        et1.setText("");
        et2.setText("");
    ...
    public void login(View view)
    {
        ...
        if(et1.getText().toString().length()>0 && et2.getText().toString().length()>0) {
                try {
                    ...
                    //reqJSON.put("username", et1.getText().toString());
                    reqJSON.put("password", "6353");
                    //reqJSON.put("password", et2.getText().toString());
                }
