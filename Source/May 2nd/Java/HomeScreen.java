...
//             Log.d("Bitmap val",bitmap.toString());
        ...
        toggle.syncState();
         ...
         if(isNetworkAvailable() == true) {
             ...
             Toast.makeText(this, "No Network Service!",
    ...
    public boolean isNetworkAvailable() {
        ConnectivityManager cm = (ConnectivityManager) homeScreenObj
...
class Freqquest extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        headText.setText(FAQuestions[position]);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      final  RowContent rowContent;
                    ...
                    try {
                        ...
                        rowContent.ques.setText(obj.getString("question"));
                        try {
                            userArray = obj.getJSONArray("users");
                            if (userArray.length() > 0) {
                                String s=String.valueOf(userArray.length()-1);
                                rowContent.flwText.setText("Followed by "+s+" people");
                            } else {
                        ...
                        if(jsonArray.length()>0) {
                            ...
                            rowContent.ans.setText( jsonObject.getString("answer"));
                ...
                if(!rowContent.upBtnAlreadyClicked)
                        {
                            ...
                            int j=Integer.parseInt(ds);
                            rowContent.upImg.setImageResource(R.drawable.uptouch1);
                            try {
                                JSONObject obj = new JSONObject(data.get(position));
                                JSONArray answerJSONArray=obj.getJSONArray("answers");
                                JSONObject answerObj=answerJSONArray.getJSONObject(0);
                               ...
                               // Log.d("dwn values dwnvoted", answerObj.toString());
                                ...
                                answerObj.put("downvote", j);
                                answerJSONArray.put(0, answerObj);
                                Log.d("Obj value", obj.toString());
                                data.set(position, obj.toString());
                                Log.d("Modified val", data.get(position));
                                sample push=new sample();
                                push.fun1(obj.toString(),"https://api.mongolab.com/api/1/databases/askumkc/collections/questionlist?apiKey=7rL6L7EoWpZnPgyjtHDS8Rwh6VDer-ic");
                            }
                            catch (Exception e){}
                            //service call here
                        }
               ...
               Boolean val= check1(rowContent);
                ...
                if(!rowContent.dwnBtnAlreadyClicked)
                {
                    ...
                    try {
                        ...
                        answerObj.put("downvoted_by", y);
                        // Log.d("dwn values dwnvoted", answerObj.toString());
                        answerObj.put("upvote", j);
                        answerObj.put("downvote", i);
                        answerJSONArray.put(0, answerObj);
                        Log.d("Obj value", obj.toString());
                        data.set(position, obj.toString());
                        Log.d("Modified val", data.get(position));
        ...
        rowContent.flw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    userMailID=jsonObject1.getString("emailid");
                ...
                if(b.getText().equals("Unfollow"))
                {
                    ...
                    try {
                        JSONObject obj = new JSONObject(data.get(position));
                        JSONArray flwjsonArray=obj.getJSONArray("users");
                        flwjsonArray.put(userMailID);
                        Log.d("Followers", flwjsonArray.toString());
                        Log.d("Total json",obj.toString());
                    }
                    catch (Exception e){}
                }
